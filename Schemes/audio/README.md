...
```
Here, *.../matlab/* points to the instance of MATLAB installed on the machine (e.g., default path on Ubuntu is */usr/local/MATLAB/R2017a*), the remaining arguments are the same as described above. 
