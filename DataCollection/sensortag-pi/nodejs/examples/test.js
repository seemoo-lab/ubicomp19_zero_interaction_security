  ...
  async.series([
      ...
      function(callback) {
        if (USE_READ) {
          ...
          sensorTag.setIrTemperaturePeriod(300, function(error) {
      ...
      function(callback) {
        if (USE_READ) {
          ...
          sensorTag.setAccelerometerPeriod(300, function(error) {
      ...
      function(callback) {
        if (USE_READ) {
          ...
          sensorTag.setHumidityPeriod(300, function(error) {
      ...
      function(callback) {
        if (USE_READ) {
          ...
          sensorTag.setMagnetometerPeriod(300, function(error) {
      ...
      function(callback) {
        if (USE_READ) {
          ...
          sensorTag.setBarometricPressurePeriod(300, function(error) {
      ...
      function(callback) {
        if (USE_READ) {
          ...
          sensorTag.setGyroscopePeriod(300, function(error) {
          ...
          async.series([
            ...
            function(callback) {
              if (USE_READ) {
                ...
                sensorTag.setLuxometerPeriod(300, function(error) {
